    ...
    public class ImagedComboBox : ComboBox
    {
        ...
        private void ComboBoxDrawItemEvent(object sender, DrawItemEventArgs e)
        {
            ...
            if (e.Index != -1)
            {
                ...
                e.Graphics.DrawImage(comboboxItem.Image, e.Bounds.X, e.Bounds.Y, ItemHeight * 1.33f, ItemHeight);
                ...
                e.Graphics.DrawString(Items[e.Index].Value.ToString(), Font, Brushes.Black,
                                      new RectangleF(e.Bounds.X + (ItemHeight * 1.33f), e.Bounds.Y, DropDownWidth,
                                                     ItemHeight));
            }
